...
namespace WebHospital.Controllers
{
    public class MunicipiosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idMunicipio,Nombre_muni,estado")] Municipio municipio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idMunicipio,Nombre_muni,estado")] Municipio municipio)
        {
            if (ModelState.IsValid)
            {
